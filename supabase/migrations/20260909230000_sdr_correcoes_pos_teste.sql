...
-- SELECT public.rodizio_etapas_entrada('00000000-0000-0000-0000-000000000010');  -- sem Contratado/Não contratado/Compareceu
-- SELECT proname FROM pg_proc WHERE proname IN ('rodizio_solta_reservas','sdr_marcar_comparecimento');
-- SELECT count(*) FROM public.sdr_destinos_transferencia();  -- como SDR: sem linha 'posvenda'
