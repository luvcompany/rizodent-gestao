ALTER TABLE public.pagamentos ADD COLUMN IF NOT EXISTS nao_marketing boolean NOT NULL DEFAULT false;
COMMENT ON COLUMN public.pagamentos.nao_marketing IS 'Exclusao do faturamento de marketing por marca gravada - independente da regra de orto; setada so na entrada do pagamento, nunca recalculada retroativamente.';
