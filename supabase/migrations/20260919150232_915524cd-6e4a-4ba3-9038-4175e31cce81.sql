-- lovable-cron-fallback-reviewed: 288 runs/day; a mudança para "Contratado" precisa acontecer pouco depois do fim da carência de 24 h de cada lead, então a fila é varrida a cada 5 min (atraso máximo de 5 min)
-- ============================================================================
