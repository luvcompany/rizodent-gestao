-- lovable-cron-fallback-reviewed: 1440 runs/day; reconstrução em lote das ~91 mil mensagens antigas; a própria função faz cron.unschedule quando não sobra nada
-- ============================================================================
