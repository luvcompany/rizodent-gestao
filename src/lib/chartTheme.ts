// Theme-aware chart styling utilities
// Returns computed HSL values from CSS variables so charts adapt to light/dark mode
...
export function getChartColors() {
  ...
  const labelColor = isDark ? "hsl(0,0%,75%)" : "hsl(0,0%,30%)";
