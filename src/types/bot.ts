...
export const NODE_DEFINITIONS: NodeDefinition[] = [
  ...
  // Messages
  { type: 'send_text', label: 'Mensagem de Texto', icon: '💬', category: 'message', color: '#3b82f6', description: 'Envia texto simples ou modelo via WhatsApp', defaultData: { text: '', templateId: '' } },
  ...
  { type: 'schedule', label: 'Programar Envio', icon: '📅', category: 'logic', color: '#a855f7', description: 'Programa o próximo bloco para uma data/hora', defaultData: { scheduleMode: 'next_day', scheduleTime: '09:00', scheduleDate: '' } },
  // Actions
