...
import { FileBarChart, Download, Share2, MessageCircle, Mail, Calendar, TrendingUp, Filter, DollarSign, Users, Stethoscope, CreditCard, Megaphone, Eye } from "lucide-react";
...
const Relatorios = () => {
  ...
  return (
    <div className="animate-fade-in space-y-6" ref={reportRef}>
      ...
      <Tabs defaultValue="contratado" className="space-y-4">
        <TabsList className="bg-secondary flex-wrap h-auto gap-1 p-1">
          <TabsTrigger value="contratado" className="text-xs"><DollarSign size={14} className="mr-1" />Contratado vs Pago</TabsTrigger>
          <TabsTrigger value="diario" className="text-xs"><Calendar size={14} className="mr-1" />Diário</TabsTrigger>
          <TabsTrigger value="semanal" className="text-xs"><Calendar size={14} className="mr-1" />Semanal</TabsTrigger>
          <TabsTrigger value="funil" className="text-xs"><Filter size={14} className="mr-1" />Funil</TabsTrigger>
          <TabsTrigger value="previsibilidade" className="text-xs"><TrendingUp size={14} className="mr-1" />Previsibilidade</TabsTrigger>
          <TabsTrigger value="procedimento" className="text-xs"><Stethoscope size={14} className="mr-1" />Procedimento</TabsTrigger>
          <TabsTrigger value="forma_pgto" className="text-xs"><CreditCard size={14} className="mr-1" />Forma Pgto</TabsTrigger>
          <TabsTrigger value="ranking" className="text-xs"><Users size={14} className="mr-1" />Ranking</TabsTrigger>
          <TabsTrigger value="especialidade" className="text-xs"><Stethoscope size={14} className="mr-1" />Especialidade</TabsTrigger>
          <TabsTrigger value="origem" className="text-xs"><Megaphone size={14} className="mr-1" />Origem/Anúncio</TabsTrigger>
        </TabsList>

        {/* ===== CONTRATADO VS PAGO ===== */}
        <TabsContent value="contratado">
          <Card className="gradient-card border-border shadow-card">
            <CardHeader className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <CardTitle className="text-base flex items-center gap-2">
                <DollarSign size={18} className="text-primary" /> Contratado vs Pago
              </CardTitle>
          ...
          <Dialog open={showContratadoDialog} onOpenChange={setShowContratadoDialog}>
            <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
              <DialogHeader>
                <DialogTitle>Detalhes Contratado vs Pago</DialogTitle>
              </DialogHeader>
                ...
                <div>
                  ...
                  <div className="overflow-x-auto">
                    <Table>
                      <TableHeader>
                        <TableRow>
                          <TableHead>Paciente</TableHead><TableHead>Contratado</TableHead><TableHead>Pago</TableHead><TableHead>Restante</TableHead><TableHead>%</TableHead>
                        </TableRow>
                      </TableHeader>
                      <TableBody>
                          ...
                          <TableRow key={i}>
                            ...
                            <TableCell>
                              <Badge variant="outline" className="bg-destructive/10 text-destructive border-destructive/30">
                                {p.contratado > 0 ? ((p.pago / p.contratado) * 100).toFixed(0) : 0}%
                              </Badge>
                            </TableCell>
                          </TableRow>
                        ))}
                ...
                <div>
                  ...
                  <div className="overflow-x-auto">
                    <Table>
                      <TableHeader>
                        <TableRow>
                          <TableHead>Paciente</TableHead><TableHead>Contratado</TableHead><TableHead>Pago</TableHead>
                        </TableRow>
                      </TableHeader>
                      <TableBody>
